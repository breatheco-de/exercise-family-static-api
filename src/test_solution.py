...
def test_add_empty_reponse_body(client):
    response = client.post('/members', json={"first_name": "Sandra",
                                             "age": 12,
                                             "id": 4446,
...
@pytest.mark.it("Method GET /members/<int:id> should exist")
def test_get_single_member_implemented(client):
    response = client.get('/members/3443')
    assert response.status_code == 200


@pytest.mark.it("Method GET /members/<int:id> should return a one single family member in a dictionary format")
...
@pytest.mark.it("Method GET /members/3443 should return Tommy")
...
@pytest.mark.it("Implement method DELETE /members/<int:id> to delete a family member")
...
def test_delete_response(client):
    client.post('/members', json={"first_name": "Tommy",
                                  "id": 3443,
                                  "age": 23,
                                  "lucky_numbers": [34,65,23,4,6]})
    response = client.delete('/members/3443')
